...
<head>
    ...
    <link rel='stylesheet' id='ampersand-fonts'  href="//fast.fonts.net/cssapi/5c9ea456-8f08-40f5-a924-436319f62d0c.css" type='text/css' media='all' />
    <link rel='stylesheet' id='ampersand-fonts'  href='<?php echo get_stylesheet_directory_uri(); ?>/style.css' type='text/css' media='all' />
...
<body <?php body_class(array($avada_color_scheme,$body_class)); ?> data-spy="scroll">
	...
	<?php if( !$data['slider_position'] ||
		...
		<div class="header-wrapper">
			...
			// WE ARE OVERRIDING HEADER LAYOUT OPTIONS.  SUCH IS THE WAY OF THIS CHILD THEME. 
			
			get_template_part('custom-framework/headers/header-v1');
